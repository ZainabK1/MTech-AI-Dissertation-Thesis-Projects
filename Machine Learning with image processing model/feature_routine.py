...
if os.path.isfile("D:\\TEST\\ml_graphology_IP\\feature_list.txt"):
    print("Error: feature_list already exists.")

elif os.path.isfile("D:\\TEST\\ml_graphology_IP\\raw_feature_list.txt"):
    print("Info: raw_feature_list found.")
    with open("D:\\TEST\\ml_graphology_IP\\raw_feature_list.txt", "r") as raw_features, open("D:\\TEST\\ml_graphology_IP\\feature_list.txt", "a") as features:
