...
if os.path.isfile("D:\\TEST\\ml-graphology-master\\label_list.txt"):
    print("Error: label_list already exists.")

elif os.path.isfile("D:\\TEST\\ml-graphology-master\\feature_list.txt"):
    print("Info: feature_list found.")
    with open("feature_list", "r") as features, open("D:\\TEST\\ml-graphology-master\\label_list.txt", "a") as labels:
